...
#define CUSTOM_MACHINE_NAME "FrankenVORON"
...
//#define HOTEND_OFFSET_Z { -7.9, 0.00 }  // (mm) relative Z-offset for each nozzle
...
#define TEMP_BED_RESIDENCY_TIME 60   // (seconds) Time to wait for bed to "settle" in M190
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 698 } // BMG 432.28668995496616 Mobius 555 Ascender 698
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (274)    // Y point for Z homing when homing all axes (G28).
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 30), (Y_MIN_POS +  30), 20 }
